...
export class ErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) {
    console.error('[FlowSentinel Admin] Render error:', error.message, info.componentStack)
  }
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 max-w-sm w-full text-center">
          ...
          <p className="text-sm text-slate-500 leading-relaxed mb-6">
            An unexpected error occurred in the admin portal. Please reload the page.
          </p>
          <button
