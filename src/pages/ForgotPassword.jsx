            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  />
                  <p className="text-xs text-slate-400">We'll send a verification code to your email</p>
                </div>
            ...
            <div className="text-center space-y-4 py-2">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  If an account exists for <strong>{email}</strong>, a verification code has been sent.
                </p>
              </div>
              <Link to="/verify-otp" state={{ email, isAdmin: true }}>
